...
var _excluded$1 = ["clickHandler", "variant", "mode"];
...
var AwesomeButton = function AwesomeButton(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("button", {
    ...
    style: {
      '--variant-background': "".concat(theme$1[mode][variant]),
      '--variant-text-color': "".concat(variant.indexOf('hierarchy') > -1 ? theme$1['light']['text-color'] : theme$1[mode]['text-color'])
    },
...
var AwesomeLabel = function AwesomeLabel(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("label", {
    style: {
      '--variant-text-color': "".concat(theme$1[mode]['text-color'])
    }
  }, children.toUpperCase());
};
